// Contient les fonctions nécessaires pour l'affichage du Popup


// Fonction affiche le popup pour partager le score

function afficherPopup(){
    let popupBackground = document.querySelector(".popupBackground")
    // Popup masquée par défaut (display:none), ajouter la classe "active" va changer son display et la rendre visible.
    popupBackground.classList.add("active")
}


//fonction masque le popup pour partager le score
